#!/usr/bin/env python3
"""
Export all Talento USA post artboards from talento-usa-posts.html (root) as
PNGs. Mirrors screenshot_ola_empleo.py's approach.

Usage:
  python3 tools/screenshot_talento_usa.py
"""
import asyncio
import http.server
import json
...
HTML_FILE = ROOT / "talento-usa-posts.html"
OUT_DIR = ROOT / ".tmp" / "talento_posts_v2"
PORT = 8804
...
async def export_posts():
    ...
    url = f"http://localhost:{PORT}/talento-usa-posts.html"
